...
namespace Core.Repositories
{
    ...
    public class EfRepositoryBase<TEntity, TPrimaryKey> : IRepository<TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        /// <summary>
        /// Gets EF DbContext object.
        /// </summary>
        protected EfDataContext Context
        {
            get { return EfUnitOfWork.Current.Context as EfDataContext; }
        }
